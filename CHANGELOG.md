...
- **npm**: Match published package repository metadata to GitHub Actions provenance validation.
...
- **npm**: Match published package repository metadata to npm's trusted-publisher repository identity.
- **release**: Carries the `0.1.0-alpha.73` runtime fixes through a working npm-published alpha.

## [0.1.0-alpha.78] - 2026-06-04

### Release Infrastructure

- **npm**: Match npm trusted publishing requirements with current setup-node release tooling and literal GitHub repository URLs in published package metadata.
- **release**: Carries the `0.1.0-alpha.73` runtime fixes through a working npm-published alpha.
...
- **npm**: Publish from GitHub Actions through npm trusted publishing without carrying token-based npm auth into the publish steps.
- **release**: Carries the `0.1.0-alpha.73` runtime fixes through a working npm-published alpha.
