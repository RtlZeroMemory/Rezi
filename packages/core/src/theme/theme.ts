...
function buildColorIndex(theme: ThemeDefinition): ThemeColors {
  ...
  return Object.freeze({
    ...
    "syntax.keyword": widget.syntax.keyword,
    "syntax.type": widget.syntax.type,
    "syntax.string": widget.syntax.string,
    "syntax.number": widget.syntax.number,
    "syntax.comment": widget.syntax.comment,
    "syntax.operator": widget.syntax.operator,
    "syntax.punctuation": widget.syntax.punctuation,
    "syntax.function": widget.syntax.function,
    "syntax.variable": widget.syntax.variable,
    "syntax.cursor.fg": widget.syntax.cursorFg,
    "syntax.cursor.bg": widget.syntax.cursorBg,
    "widget.diff.add.bg": widget.diff.addBg,
    "widget.diff.delete.bg": widget.diff.deleteBg,
    "widget.diff.add.fg": widget.diff.addFg,
    "widget.diff.delete.fg": widget.diff.deleteFg,
    ...
    "widget.logs.level.trace": widget.logs.trace,
    "widget.logs.level.debug": widget.logs.debug,
    "widget.logs.level.info": widget.logs.info,
    "widget.logs.level.warn": widget.logs.warn,
    "widget.logs.level.error": widget.logs.error,
